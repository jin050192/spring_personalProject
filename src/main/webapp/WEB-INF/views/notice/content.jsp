...
<div id="content">
	...
	onclick="window.location='${pathA}/admin/modifyFormNotice?num=${dto.num}&pageNum=${pageNum}'">
	<input class="input" type="button" value="글삭제"
	onclick="window.location='${pathA}/admin/deleteNoticePro?num=${dto.num}&pageNum=${pageNum}'">
	</c:if>
	<input class="input" type="button" value="목록보기" 
	onclick="window.location='new&event?pageNum=${pageNum}'">   
</div>
